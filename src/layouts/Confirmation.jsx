...
const Confirmation = () => {
    ...
    const handleSendMessage = () => {
        ...
        window.open(`https://wa.me/6281249356051?text=${whatsappMessage}`, "_blank");
    };

    return (
        <div className='w-full bg-primary p-10'>
            <div className="lg:w-2/3 mx-auto bg-black bg-opacity-75 lg:p-20 p-10 border-4 rounded-xl space-y-4">
                <h1 className='text-center text-white text-3xl great-vibes-regular'>Konfirmasi Kehadiran</h1>
                <input
                    type="text"
                ...
                <div className="flex flex-col items-start space-y-2 text-white font-medium">
                    ...
                    <label className="inline-flex items-center">
                        <input
                            ...
                            className="form-radio text-white"
                        />
                        <span className="ml-2">Saya Masih Ragu</span>
                    </label>
                    <label className="inline-flex items-center">
                        <input
                            type="radio"
                ...
                <button
                    ...
                    className="mt-6 px-6 py-3 bg-yellow-800 text-white rounded-lg font-semibold hover:bg-yellow-700 transition duration-300"
                >
