...
const Place = () => {
    return (
        <div className='w-full py-20 space-y-5 flex flex-col justify-center items-center'>
            <h1 className='text-white text-center mx-auto text-[1.6rem] lg:text-3xl'>Bertempat di:</h1>
            <h1 className='text-white text-center lg:w-3/4 mx-auto lg:text-2xl'>Kediaman Mempelai Wanita Palongan Kapedi, Dusun Aeng Bato RT 005/ RW 006 Kapedi Bluto Sumenep</h1>
